...
`deno task crawl:namu`가 나무위키 영웅 문서의 상성/궁합, 전장 목록의 모드·전장·이미지, 전장별 문서의 공격/방어 추천 영웅과 주석을 재생성합니다. 상성 등급은 문서 항목의 첫 등급 표기를 사용하고, 궁합 등급은 본문 키워드로 자동 분류합니다. 전장 문서에 추천 영웅 표기가 없는 맵은 비활성화합니다.
