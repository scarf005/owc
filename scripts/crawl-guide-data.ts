...
const writeJsonc = (path: string, comment: string, value: unknown) =>
  Deno.writeTextFile(path, `// ${comment}\n${JSON.stringify(value, null, 2)}\n`)

await writeJsonc(
  "src/data/overwatch.jsonc",
  "Generated by scripts/crawl-guide-data.ts from Namu Wiki hero and matchup pages.",
  { heroes, matchups },
)
await writeJsonc(
  "src/data/guide.jsonc",
  "Generated by scripts/crawl-guide-data.ts from Namu Wiki synergy and map pages.",
  {
    synergyRatings: [
